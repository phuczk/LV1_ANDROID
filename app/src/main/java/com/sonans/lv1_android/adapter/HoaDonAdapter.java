...
public class HoaDonAdapter extends RecyclerView.Adapter<HoaDonAdapter.ViewHolder>{
    ...
    public HoaDonAdapter(@NonNull Context context, HoaDonFragment fragment, List<HoaDon> lists, HoaDonDao dao) {
    ...
    public HoaDonAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.tem_rcv_hd, parent, false);
